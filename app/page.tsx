  ...
  return (
      <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="bg-gradient-to-r from-red-500/10 to-orange-500/10 border-b border-red-500/20 py-3"
        >
          <div className="container mx-auto px-4 text-center">
            <div className="flex items-center justify-center gap-2 text-xs md:text-base">
              <span className="animate-pulse">🔥</span>
              <span className="text-red-700 font-medium">
                Limited Early Access - Only <span className="text-red-800 font-bold">{Math.max(400 - realSubscriberCount, 153)}</span> spots remaining
              </span>
              <span className="animate-pulse">🔥</span>
            </div>
          </div>
        ...
        <div className="container mx-auto px-2 md:px-6 pt-8 md:pt-12">
          <div className="text-center mb-8">
            ...
            <div className="mt-4 md:mt-8">
              ...
              <h1 className="text-gray-900 font-bold px-1 pt-2 leading-tight md:mb-0 lg:mb-[-0.5rem]" 
              ...
              >
                <div className="text-xs text-gray-600 font-medium">Works with:</div>
          ...
          >
            ...
            >
              ...
              <div className="hidden md:flex flex-wrap gap-2">
                {[
                  { name: 'Bundle', color: 'bg-blue-100 border-blue-300', icon: '📦' },
                  { name: 'Reviews', color: 'bg-green-100 border-green-300', icon: '⭐' },
                  { name: 'Timer', color: 'bg-purple-100 border-purple-300', icon: '⏰' },
                  { name: 'Social', color: 'bg-orange-100 border-orange-300', icon: '💬' },
                  { name: 'Trust', color: 'bg-teal-100 border-teal-300', icon: '🛡️' },
                  { name: 'Offers', color: 'bg-pink-100 border-pink-300', icon: '🎁' },
                ].map((module, index) => (
                  <motion.div
                    key={module.name}
                    ...
                    className={`${module.color} px-2 py-1 rounded text-xs text-gray-700 border flex items-center gap-1`}
                  >
                ...
                <div className="flex gap-2 pb-1" style={{ width: 'max-content' }}>
                  {[
                    ...
                    <motion.div
                      ...
                      className={`${module.color} px-2 py-1 rounded text-xs text-gray-700 border flex items-center gap-1 flex-shrink-0`}
                    >
                      <span className="text-[10px]">{module.icon}</span>
                      {module.name}
                    </motion.div>
            ...
            <div className="relative">
              <motion.div
                ...
                className="flex items-center bg-white/80 border border-gray-200 rounded-t-xl p-4 md:p-5 shadow-lg"
              >
        ...
        <div className="container mx-auto px-4 md:px-6 py-4 md:py-8">
          ...
          >
            <h2 className="text-4xl md:text-6xl lg:text-6xl font-bold mb-4 md:mb-6 text-gray-900">
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-600 mb-6 md:mb-8 leading-relaxed px-2">
              ...
              <span className="text-primary-600 font-semibold"> Customers can't tell them apart.</span>
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-8">
              <div className="bg-red-50 border border-red-200 rounded-xl p-4 md:p-6">
                <div className="flex items-center gap-2 mb-4">
                  <h3 className="text-lg md:text-xl font-bold text-red-600">❌ Most Stores</h3>
                  <div className="relative group">
                    <button 
                      className="w-5 h-5 bg-red-100 border border-red-300 rounded-full flex items-center justify-center cursor-help hover:bg-red-200 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500/50"
                      type="button"
                    ...
                    {/* Tooltip */}
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-white border border-red-200 rounded-lg text-xs text-gray-700 w-64 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity z-20 pointer-events-none shadow-lg">
                      <div className="font-semibold text-red-600 mb-1">The Hidden Testing Problem:</div>
                      ...
                      <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-red-200"></div>
                    </div>
                  </div>
                </div>
                <ul className="space-y-2 text-gray-700 text-left text-sm md:text-base">
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-4 md:p-6">
                <div className="flex items-center gap-2 mb-4">
                  <h3 className="text-lg md:text-xl font-bold text-green-600">✅ Liquidfy Stores</h3>
                  <div className="relative group">
                    <button 
                      className="w-5 h-5 bg-green-100 border border-green-300 rounded-full flex items-center justify-center cursor-help hover:bg-green-200 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500/50"
                      type="button"
                    ...
                    {/* Tooltip */}
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-white border border-green-200 rounded-lg text-xs text-gray-700 w-64 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity z-20 pointer-events-none shadow-lg">
                      <div className="font-semibold text-green-600 mb-1">The Liquidfy Solution:</div>
            ...
            >
              <h3 className="text-3xl md:text-3xl font-bold mb-6 text-center text-gray-900">
                The <span className="gradient-text">Liquidfy</span> Solution
              </h3>
              
              {/* Integrated key stats with context */}
              <div className="grid grid-cols-3 gap-3 md:gap-6 mb-6">
                <div className="text-center bg-white/80 rounded-lg p-3 md:p-4 border border-gray-200">
                  <div className="text-2xl md:text-3xl font-bold gradient-text mb-1">220+</div>
                  <div className="text-xs md:text-sm text-gray-600">Add-ons</div>
                ...
                <div className="text-center bg-white/80 rounded-lg p-3 md:p-4 border border-gray-200">
                  ...
                  <div className="text-xs md:text-sm text-gray-600">Setup Time</div>
                ...
                <div className="text-center bg-white/80 rounded-lg p-3 md:p-4 border border-gray-200">
                  ...
                  <div className="text-xs md:text-sm text-gray-600">More Sales</div>
              ...
              <p className="text-center text-gray-600 text-sm md:text-base max-w-2xl mx-auto">
                ...
                <span className="text-green-600 font-semibold"> Get everything you need in one dashboard.</span>
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 py-6 md:py-8">
          ...
          >
            <div className="text-center mb-6 md:mb-8">
              <h3 className="text-3xl md:text-3xl font-bold mb-3 text-gray-900">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 mb-6 md:mb-8">
              <motion.div
                ...
                className="bg-white/80 border border-gray-200 rounded-lg p-3 md:p-4 text-center shadow-sm"
              >
                <div className="text-xl md:text-2xl mb-2">♾️</div>
                <h4 className="text-xs md:text-sm font-semibold text-gray-900 mb-1">Unlimited Access</h4>
                <p className="text-xs text-gray-600">One license unlocks everything. No monthly fees.</p>
              </motion.div>
              ...
              >
                ...
                <h4 className="text-xs md:text-sm font-semibold text-gray-900 mb-1">Mix & Match</h4>
                <p className="text-xs text-gray-600">Combine any modules and sections freely.</p>
              </motion.div>
              ...
              >
                <div className="text-xl md:text-2xl mb-2">🎨</div>
                <h4 className="text-xs md:text-sm font-semibold text-gray-900 mb-1">Customizable</h4>
                <p className="text-xs text-gray-600">Colors, fonts, layouts adapt to your brand.</p>
              </motion.div>
              ...
              >
                <div className="text-xl md:text-2xl mb-2">🌐</div>
                <h4 className="text-xs md:text-sm font-semibold text-gray-900 mb-1">Works Everywhere</h4>
                <p className="text-xs text-gray-600">Compatible with any Shopify theme.</p>
              </motion.div>
              ...
              >
                <div className="text-xl md:text-2xl mb-2">🚀</div>
                <h4 className="text-xs md:text-sm font-semibold text-gray-900 mb-1">Lifetime Updates</h4>
                <p className="text-xs text-gray-600">New features added regularly.</p>
              </motion.div>
              ...
              >
                <div className="text-xl md:text-2xl mb-2">👑</div>
                <h4 className="text-xs md:text-sm font-semibold text-gray-900 mb-1">Priority Support</h4>
                <p className="text-xs text-gray-600">Dedicated support for early access.</p>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="text-center bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-4 md:p-6"
            >
              <p className="text-sm md:text-base text-gray-700">
                <span className="text-green-600 font-semibold">One investment, unlimited possibilities.</span> 
        ...
        <div className="container mx-auto px-4 md:px-6 pb-8 md:pb-12">
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.7 }}
            className="text-center bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl md:rounded-2xl p-4 md:p-8 mx-2 md:mx-0 shadow-lg"
          >
            <h4 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 md:mb-4 text-gray-900">
              Don't Build Another <span className="text-red-600"><br/>Generic Store</span>
            </h4>
            <p className="text-gray-700 mb-4 md:mb-6 max-w-2xl mx-auto text-sm md:text-base">
              Join <span className="text-gray-900 font-bold">{realSubscriberCount}+ store owners</span> who are getting early access to everything they need for a store that actually converts. 
              <span className="text-green-600 font-semibold"> Save up to +$100 on launch day.</span>
            </p>
