  ...
  return (
      <main className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="flex items-center justify-center gap-2 text-xs md:text-base">
              ...
              <span className="text-red-300 font-medium">
                Limited Early Access - Only <span className="text-red-200 font-bold">{Math.max(400 - realSubscriberCount, 153)}</span> spots remaining
              </span>
              <span className="animate-pulse">🔥</span>
            </div>
          </div>
        ...
        <div className="container mx-auto px-2 md:px-6 pt-8 md:pt-12">
          <div className="text-center mb-8">
            ...
            <div className="mt-4 md:mt-8">
              ...
              >
                <div className="text-sm text-gray-300 font-medium">Works with:</div>
          ...
          >
            ...
            >
              ...
              <div className="hidden md:flex flex-wrap gap-2">
                {[
                  { name: 'Bundle', color: 'bg-blue-900/40 border-blue-700/50', icon: '📦' },
                  { name: 'Reviews', color: 'bg-green-900/40 border-green-700/50', icon: '⭐' },
                  { name: 'Timer', color: 'bg-purple-900/40 border-purple-700/50', icon: '⏰' },
                  { name: 'Social', color: 'bg-orange-900/40 border-orange-700/50', icon: '💬' },
                  { name: 'Trust', color: 'bg-teal-900/40 border-teal-700/50', icon: '🛡️' },
                  { name: 'Offers', color: 'bg-pink-900/40 border-pink-700/50', icon: '🎁' },
                ].map((module, index) => (
                  <motion.div
                    key={module.name}
                    ...
                    className={`${module.color} px-2 py-1 rounded text-sm text-gray-300 border flex items-center gap-1`}
                  >
                ...
                <div className="flex gap-2 pb-1" style={{ width: 'max-content' }}>
                  {[
                    ...
                    <motion.div
                      ...
                      className={`${module.color} px-2 py-1 rounded text-sm text-gray-300 border flex items-center gap-1 flex-shrink-0`}
                    >
                      <span className="text-[10px]">{module.icon}</span>
                      {module.name}
                    </motion.div>
            ...
            <div className="relative">
              <motion.div
                ...
                className="flex items-center bg-gray-900/95 border border-gray-700 rounded-t-xl p-4 md:p-5 shadow-lg"
              >
                  ...
                  >
                    ...
                    >
                                              <span className="text-primary-400">220+ add-ons</span> found for your store...
                    </motion.div>
                  </motion.div>
                  <motion.div
        ...
        <div className="container mx-auto px-4 md:px-6 py-4 md:py-8">
          ...
          >
            <h2 className="text-4xl md:text-6xl lg:text-6xl font-bold mb-4 md:mb-6 text-white">
            Why Your Store <br/>Need <span className="gradient-text">Liquidfy</span>
            </h2>
            <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-6 md:mb-8 leading-relaxed px-2">
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-8">
              <div className="bg-red-900/40 border border-red-700/50 rounded-xl p-4 md:p-6">
                <div className="flex items-center gap-2 mb-4">
                  <h3 className="text-lg md:text-xl font-bold text-red-400">❌ Most Stores</h3>
                  <div className="relative group">
                    <button 
                      className="w-5 h-5 bg-red-800/50 border border-red-600/50 rounded-full flex items-center justify-center cursor-help hover:bg-red-700/50 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500/50"
                      type="button"
                    ...
                    {/* Tooltip */}
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 border border-red-600/50 rounded-lg text-xs text-gray-300 w-64 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity z-20 pointer-events-none shadow-lg">
                      ...
                      <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-red-600/50"></div>
                    </div>
                  </div>
                </div>
                <ul className="space-y-2 text-gray-300 text-left text-base md:text-lg">
              ...
              <div className="bg-green-900/40 border border-green-700/50 rounded-xl p-4 md:p-6">
                <div className="flex items-center gap-2 mb-4">
                  <h3 className="text-lg md:text-xl font-bold text-green-400">✅ Liquidfy Stores</h3>
                  <div className="relative group">
                    <button 
                      className="w-5 h-5 bg-green-800/50 border border-green-600/50 rounded-full flex items-center justify-center cursor-help hover:bg-green-700/50 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500/50"
                      type="button"
                      aria-label="More information about Liquidfy solutions"
                    >
                      <span className="text-green-300 text-xs font-bold leading-none">+</span>
                    </button>
                    {/* Tooltip */}
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 border border-green-600/50 rounded-lg text-xs text-gray-300 w-64 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity z-20 pointer-events-none shadow-lg">
                      ...
                      <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-green-600/50"></div>
                    </div>
                  </div>
                </div>
                <ul className="space-y-2 text-gray-300 text-left text-base md:text-lg">
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-primary-500/20 to-purple-500/20 border border-primary-500/30 rounded-xl p-6 md:p-8 mt-8"
            >
              <h3 className="text-3xl md:text-3xl font-bold mb-6 text-center text-white">
                The <span className="gradient-text">Liquidfy</span> Solution
              </h3>
              
              {/* Integrated key stats with context */}
              <div className="grid grid-cols-3 gap-3 md:gap-6 mb-6">
                <div className="text-center bg-gray-900/95 rounded-lg p-3 md:p-4 border border-gray-700">
                  <div className="text-2xl md:text-3xl font-bold gradient-text mb-1">220+</div>
                  <div className="text-sm md:text-base text-gray-300">Premium Add-ons</div>
                  <div className="text-xs text-gray-400 mt-1">Ready to copy-paste</div>
                </div>
                <div className="text-center bg-gray-900/95 rounded-lg p-3 md:p-4 border border-gray-700">
                  ...
                  <div className="text-xs text-gray-400 mt-1">No coding required</div>
                </div>
                <div className="text-center bg-gray-900/95 rounded-lg p-3 md:p-4 border border-gray-700">
                  <div className="text-2xl md:text-3xl font-bold gradient-text mb-1">3x</div>
                  <div className="text-sm md:text-base text-gray-300">More Sales</div>
                  <div className="text-xs text-gray-400 mt-1">Copied 7-digit stores</div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6 py-6 md:py-8">
          ...
          >
            <div className="text-center mb-6 md:mb-8">
              <h3 className="text-3xl md:text-3xl font-bold mb-3 text-white">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 mb-6 md:mb-8">
              <motion.div
                ...
                className="bg-gray-900/95 border border-gray-700 rounded-lg p-3 md:p-4 text-center shadow-sm"
              >
                <div className="text-xl md:text-2xl mb-2">♾️</div>
                <h4 className="text-sm md:text-base font-semibold text-white mb-1">Unlimited Access</h4>
                <p className="text-sm text-gray-300">One license unlocks everything. No monthly fees.</p>
              </motion.div>
              ...
              >
                ...
                <h4 className="text-sm md:text-base font-semibold text-white mb-1">Mix & Match</h4>
                <p className="text-sm text-gray-300">Combine any modules and sections freely.</p>
              </motion.div>
              ...
              >
                <div className="text-xl md:text-2xl mb-2">🎨</div>
                <h4 className="text-sm md:text-base font-semibold text-white mb-1">Customizable</h4>
                <p className="text-sm text-gray-300">Colors, fonts, layouts adapt to your brand.</p>
              </motion.div>
              ...
              >
                <div className="text-xl md:text-2xl mb-2">🌐</div>
                <h4 className="text-sm md:text-base font-semibold text-white mb-1">Works Everywhere</h4>
                <p className="text-sm text-gray-300">Compatible with any Shopify theme.</p>
              </motion.div>
              ...
              >
                <div className="text-xl md:text-2xl mb-2">🚀</div>
                <h4 className="text-sm md:text-base font-semibold text-white mb-1">Lifetime Updates</h4>
                <p className="text-sm text-gray-300">New features added regularly.</p>
              </motion.div>
              ...
              >
                <div className="text-xl md:text-2xl mb-2">👑</div>
                <h4 className="text-sm md:text-base font-semibold text-white mb-1">Priority Support</h4>
                <p className="text-sm text-gray-300">Dedicated support for early access.</p>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="text-center bg-gradient-to-r from-blue-900/40 to-purple-900/40 border border-blue-700/50 rounded-lg p-4 md:p-6"
            >
        ...
        <div className="container mx-auto px-4 md:px-6 pb-8 md:pb-12">
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.7 }}
            className="text-center bg-gradient-to-r from-blue-900/40 to-purple-900/40 border border-blue-700/50 rounded-xl md:rounded-2xl p-4 md:p-8 mx-2 md:mx-0 shadow-lg"
          >
            <h4 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 md:mb-4 text-white">
              Don't Build Another <span className="text-red-400"><br/>Generic Store</span>
            </h4>
            <p className="text-gray-300 mb-4 md:mb-6 max-w-2xl mx-auto text-base md:text-lg">
              Join <span className="text-gray-100 font-bold">{realSubscriberCount}+ store owners</span> who are getting early access to everything they need for a store that actually converts. 
              <span className="text-green-400 font-semibold"> Save up to +$100 on launch day.</span>
            </p>
            
            <div className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 text-sm md:text-base text-gray-300">
